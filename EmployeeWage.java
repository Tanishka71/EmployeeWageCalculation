...
class EmpWageBuilder implements EmpWageBuilderInterface {
    ...
    private void calculateMonthlyWage(CompanyEmpWage companyEmpWage) {
        ...
        while (i <= companyEmpWage.getDaysWorked() && totalHours <= 100) {
            ...
            if (presence == 1) {
                ...
                if (check == 1) {
                    ...
                    dailyWages.add((companyEmpWage.getFullDayHours() * companyEmpWage.getWagePerHour()));
        ...
        System.out.print("The daily wages of the employee for "+companyEmpWage.getCompanyName()+"is:");
        for(int ele:dailyWages) {
